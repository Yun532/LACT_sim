                    ...
                    std::size_t& emitted_2d)
{
    ...
    for (int i = 0; i < nbunches; ++i) {
        ...
        on_bunch(makeBunch(b, current_event_id, array_id, event_id,
                           telescope_id, static_cast<std::uint64_t>(i), cfg));
        ++emitted;
        ++emitted_2d;
    }
                      ...
                      std::size_t& emitted_3d)
{
    ...
    for (int i = 0; i < nbunches; ++i) {
        ...
        on_bunch(makeBunch3d(b, current_event_id, array_id, event_id,
                             telescope_id, static_cast<std::uint64_t>(i), cfg));
        ++emitted;
        ++emitted_3d;
    }
